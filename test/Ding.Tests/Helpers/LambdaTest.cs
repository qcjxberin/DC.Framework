...
namespace Ding.Tests.Helpers {
    ...
    public class LambdaTest {
        ...
        public void TestGetValue_NewGuid() {
            ...
            Assert.NotEqual( Guid.Empty, Ding.Utils.Helpers.Convert.ToGuid( value ) );
        }
        ...
        public void TestGetValue_DateTimeNow() {
            ...
            var value = Lambda.GetValue( expression );
            Assert.NotNull(Ding.Utils.Helpers.Convert.ToDateOrNull( value ) );
        }
        ...
        public void TestGetValue_Instance() {
            ...
            Assert.True(Ding.Utils.Helpers.Convert.ToBool( Lambda.GetValue( expression4 ) ) );
        }
        ...
        public void TestGetValue_Enum() {
            ...
            Expression<Func<Sample, bool>> expression = test => test.EnumValue == EnumSample.D;
            Assert.Equal( EnumSample.D.Value(), Ding.Utils.Helpers.Enum.GetValue<EnumSample>( Lambda.GetValue( expression ) ) );
