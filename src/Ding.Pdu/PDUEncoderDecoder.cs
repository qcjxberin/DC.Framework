...
namespace Ding.Pdu
{
    ...
    public class PDUEncoderDecoder
    {
        ...
        private readonly string protocolDataUnitType = "11";
        ...
        private readonly string messageReference = "00";
        ...
        private readonly string protocolIdentifer = "00";
        ...
        private string serviceCenterTimeStamp = string.Empty;
        ...
        private readonly string validityPeriod = "C4";       // 暂时固定有效期
        ...
        private string userDataLenghth = string.Empty;
