using Ding.Offices.Excels.Core.Styles;
using NPOI.SS.UserModel;

namespace Ding.Offices.Excels.Npoi.Resolvers
{
    /// <summary>
    /// 单元格样式解析器
    /// </summary>
    public class CellStyleResolver
    {
        ...
        {
            if (_style.Alignment == Ding.Offices.Excels.Core.Styles.HorizontalAlignment.Left)
            {
                return NPOI.SS.UserModel.HorizontalAlignment.Left;
            }

            if (_style.Alignment == Ding.Offices.Excels.Core.Styles.HorizontalAlignment.Right)
            {
        ...
        {
            if (_style.VerticalAlignment == Ding.Offices.Excels.Core.Styles.VerticalAlignment.Top)
            {
                return NPOI.SS.UserModel.VerticalAlignment.Top;
            }
            if (_style.VerticalAlignment == Ding.Offices.Excels.Core.Styles.VerticalAlignment.Bottom)
            {
        ...
        private NPOI.SS.UserModel.FillPattern ConvertFillPattern(
            Ding.Offices.Excels.Core.Styles.FillPattern fillPattern)
        {
            switch (fillPattern)
            {
                case Ding.Offices.Excels.Core.Styles.FillPattern.NoFill:
                    return NPOI.SS.UserModel.FillPattern.NoFill;
                case Ding.Offices.Excels.Core.Styles.FillPattern.SolidForeground:
                    return NPOI.SS.UserModel.FillPattern.SolidForeground;
                case Ding.Offices.Excels.Core.Styles.FillPattern.FineDots:
                    return NPOI.SS.UserModel.FillPattern.FineDots;
                case Ding.Offices.Excels.Core.Styles.FillPattern.AltBars:
                    return NPOI.SS.UserModel.FillPattern.AltBars;
                case Ding.Offices.Excels.Core.Styles.FillPattern.SparseDots:
                    return NPOI.SS.UserModel.FillPattern.SparseDots;
                case Ding.Offices.Excels.Core.Styles.FillPattern.ThickHorizontalBands:
                    return NPOI.SS.UserModel.FillPattern.ThickHorizontalBands;
                case Ding.Offices.Excels.Core.Styles.FillPattern.ThickVerticalBands:
                    return NPOI.SS.UserModel.FillPattern.ThickVerticalBands;
                case Ding.Offices.Excels.Core.Styles.FillPattern.ThickBackwardDiagonals:
                    return NPOI.SS.UserModel.FillPattern.ThickBackwardDiagonals;
                case Ding.Offices.Excels.Core.Styles.FillPattern.ThickForwardDiagonals:
                    return NPOI.SS.UserModel.FillPattern.ThickForwardDiagonals;
                case Ding.Offices.Excels.Core.Styles.FillPattern.BigSpots:
                    return NPOI.SS.UserModel.FillPattern.BigSpots;
                case Ding.Offices.Excels.Core.Styles.FillPattern.Bricks:
                    return NPOI.SS.UserModel.FillPattern.Bricks;
                case Ding.Offices.Excels.Core.Styles.FillPattern.ThinHorizontalBands:
                    return NPOI.SS.UserModel.FillPattern.ThinHorizontalBands;
                case Ding.Offices.Excels.Core.Styles.FillPattern.ThinVerticalBands:
                    return NPOI.SS.UserModel.FillPattern.ThinVerticalBands;
                case Ding.Offices.Excels.Core.Styles.FillPattern.ThinBackwardDiagonals:
                    return NPOI.SS.UserModel.FillPattern.ThinBackwardDiagonals;
                case Ding.Offices.Excels.Core.Styles.FillPattern.ThinForwardDiagonals:
                    return NPOI.SS.UserModel.FillPattern.ThinForwardDiagonals;
                case Ding.Offices.Excels.Core.Styles.FillPattern.Squares:
                    return NPOI.SS.UserModel.FillPattern.Squares;
                case Ding.Offices.Excels.Core.Styles.FillPattern.Diamonds:
                    return NPOI.SS.UserModel.FillPattern.Diamonds;
                case Ding.Offices.Excels.Core.Styles.FillPattern.LessDots:
                    return NPOI.SS.UserModel.FillPattern.LessDots;
                case Ding.Offices.Excels.Core.Styles.FillPattern.LeastDots:
