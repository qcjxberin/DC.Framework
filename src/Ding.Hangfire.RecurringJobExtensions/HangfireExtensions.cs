...
{
    /// <summary>
    /// Hangfire <see cref="RecurringJob"/>扩展名。
    /// </summary>
    public static class HangfireExtensions
    {
        /// <summary>
        /// 在指定的接口或类中自动构建<see cref="RecurringJob"/>。
        /// 对于Hangfire客户端，或者使用类<seealso cref="CronJob"/>来添加或更新<see cref="RecurringJob"/>。
        /// </summary>
        /// <param name="configuration"> <see cref="IGlobalConfiguration"/> </param>
        /// <param name="types">指定的接口或类</param>
