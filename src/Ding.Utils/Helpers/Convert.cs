...
namespace Ding.Utils.Helpers {
    ...
    public static class Conv {
        ...
        {
            return ToFloat(input, default, digits);
        }
        ...
        {
            return ToDouble(input, default, digits);
        }
        ...
        {
            return ToDecimal(input, default, digits);
        }
