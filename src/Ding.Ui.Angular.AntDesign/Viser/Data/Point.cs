...
namespace Ding.Ui.Viser.Data {
    ...
    public class Point {
        ...
        public JProperty ToJProperty() {
            return new JProperty( Name, Ding.Helpers.Convert.ToDouble( Value ) );
        }
        ...
        public JProperty ToColumnJProperty() {
            ...
            return new JProperty( _item.Name, Ding.Helpers.Convert.ToDouble( Value ) );
        }
    }
}
