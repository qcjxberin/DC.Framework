using Ding.ExpressDelivery.Exceptions;
using Ding.ExpressDelivery.Kdniao.Configuration;
using Ding.ExpressDelivery.Kdniao.Core;
using Ding.ExpressDelivery.Kdniao.Enums;
using Ding.ExpressDelivery.Kdniao.Models;
...
namespace Ding.ExpressDelivery.Kdniao
{
    /// <summary>
    /// 快递鸟 客户端
    /// </summary>
