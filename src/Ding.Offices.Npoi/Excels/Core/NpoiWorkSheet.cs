...
using Ding.Offices.Npoi.Extensions;
using NPOI.SS.UserModel;

namespace Ding.Offices.Npoi.Excels.Core
{
    /// <summary>
    /// 基于NPOI的工作表
    /// </summary>
    public class NpoiWorkSheet: Ding.Offices.Excels.Core.WorkSheetBase
    {
        /// <summary>
        /// 工作表
        /// </summary>
        ...
        /// <returns></returns>
        public override Ding.Offices.Excels.Abstractions.IRange GetRange(int startRowIndex, int startColumnIndex, int endRowIndex, int endColumnIndex)
        {
        ...
        /// <param name="columnIndex">列索引</param>
        /// <returns></returns>
        public override Ding.Offices.Excels.Abstractions.ICell GetCell(int rowIndex, int columnIndex)
        {
        ...
        /// <param name="rowIndex">行索引</param>
        /// <returns></returns>
        public override Ding.Offices.Excels.Abstractions.IRow GetRow(int rowIndex)
        {
        ...
        /// <param name="columnIndex">列索引</param>
        /// <returns></returns>
        public override Ding.Offices.Excels.Abstractions.IColumn GetColumn(int columnIndex)
        {
        ...
        public override void SetRangeColor(Ding.Offices.Excels.Abstractions.IRange range, Color color)
        {
        ...
        /// </summary>
        /// <param name="range">行列范围</param>
        public override void MergeCell(Ding.Offices.Excels.Abstractions.IRange range)
        {
            range.Merge();
        }
