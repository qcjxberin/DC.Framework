...
namespace Ding.Datas.Dapper.Sqlite
{
    ...
    public class SqliteFromClause : FromClause
    {
        ...
        public SqliteFromClause(ISqlBuilder builder, IDialect dialect, IEntityResolver resolver, IEntityAliasRegister register, ITableDatabase tableDatabase, SqlItem table = null)
