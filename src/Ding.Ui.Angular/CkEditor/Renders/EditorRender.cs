...
using Ding.Ui.CkEditor.Builders;
using Ding.Ui.CkEditor.Configs;
using Ding.Ui.CkEditor.Resolvers;
using Ding.Ui.Configs;

namespace Ding.Ui.CkEditor.Renders {
    /// <summary>
    /// 富文本框编辑器渲染器
    /// </summary>
    public class EditorRender : AngularRenderBase {
        ...
        private void ConfigCkEditor( TagBuilder builder ) {
            ...
            var json = Ding.Helpers.Json.ToJson( config, true );
            if ( json == "{}" )
                return;
