...
namespace Ding.Helpers
{
    ...
    public static class ColorConverter
    {
        ...
        public static Color GetColorFromCssString(string cssColour)
        {
            ...
            Match m1 = System.Text.RegularExpressions.Regex.Match(cssColour, @"^#?([A-F\d]{2})([A-F\d]{2})([A-F\d]{2})([A-F\d]{2})?",
            ...
            {
                Match m2 = System.Text.RegularExpressions.Regex.Match(cssColour, @"^#?([A-F\d])([A-F\d])([A-F\d])$",
