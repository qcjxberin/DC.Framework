...
namespace Ding.HttpUtilitys
{
    ...
    public static class RequestUtility
    {
		...
		*/
        ...
        /// <returns></returns>
        public static string HttpGet(string url, CookieContainer cookieContainer = null, Encoding encoding = null, X509Certificate cer = null, int timeOut = TIME_OUT)
        {
        ...
        /// </summary>
        /// <returns></returns>
        public static string HttpPost(string url, CookieContainer cookieContainer = null, Dictionary<string, string> formData = null, Encoding encoding = null, X509Certificate cer = null, int timeOut = TIME_OUT)
        {
        ...
        /// <returns></returns>
        public static string HttpPost(string url, CookieContainer cookieContainer = null, Stream postStream = null, Dictionary<string, string> fileDictionary = null, string refererUrl = null, Encoding encoding = null, X509Certificate cer = null, int timeOut = TIME_OUT, bool checkValidationResult = false)
        {
        ...
        /// <param name="timeOut"></param>
        /// <returns></returns>
        public static async Task<string> HttpGetAsync(string url, CookieContainer cookieContainer = null, Encoding encoding = null, X509Certificate cer = null, int timeOut = TIME_OUT)
        {
            var handler = new HttpClientHandler
            {
                CookieContainer = cookieContainer,
        ...
        /// </summary>
        /// <returns></returns>
        public static async Task<string> HttpPostAsync(string url, CookieContainer cookieContainer = null, Dictionary<string, string> formData = null, Encoding encoding = null, X509Certificate cer = null, int timeOut = TIME_OUT)
        {
            MemoryStream ms = new MemoryStream();
        ...
        /// <param name="refererUrl"></param>
        /// <returns></returns>
        public static async Task<string> HttpPostAsync(string url, CookieContainer cookieContainer = null, Stream postStream = null, Dictionary<string, string> fileDictionary = null, string refererUrl = null, Encoding encoding = null, X509Certificate cer = null, int timeOut = TIME_OUT, bool checkValidationResult = false)
        {
            if (cookieContainer == null)
                cookieContainer = new CookieContainer();
        ...
        /// <![CDATA["实践中经常导致问题的字符有：'&', '?', '=' 等,可以解决类似这样的问题：假设参数名为 tvshow, 参数值为 Tom&Jerry，如果不编码，可能得到的网址： http://a.com/?tvshow=Tom&Jerry&year=1965 编码后则为：http://a.com/?tvshow=Tom%26Jerry&year=1965"]]>
        /// <returns></returns>
